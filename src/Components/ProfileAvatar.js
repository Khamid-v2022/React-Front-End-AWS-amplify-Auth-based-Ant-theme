    ...
    <>
      <Card className="no-title">
        <img
          ...
          src="./assets/images/default_avartar.jpg"
          alt=""
        ...
        <div>
          ...
          <div style={{ display: "flex", marginTop: "5px" }}>
            <div className="medal-box">
              ...
              <span data-v-5c5a2954="" className="medal_count color-text-gold">
                9
              </span>
            </div>
            <div className="medal-box">
              ...
              <span
                data-v-5c5a2954=""
                className="medal_count color-text-silver"
              >
                9
              </span>
            </div>
            <div className="medal-box">
              ...
              <span
                data-v-5c5a2954=""
                className="medal_count color-text-bronze"
              >
                9
              </span>
            </div>
